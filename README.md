This is game called PIG. It is based on simple mathematical logic. In this game first the user will have to specify the number of players and then the game will begin. 
